...
sudo apt-get update && sudo apt-get install -y \
    swig cmake libgomp1 libjpeg-dev zlib1g-dev libpython3.8 \
    libxcursor-dev libxrandr-dev libxinerama-dev libxi-dev libegl1 \
    libglfw3-dev libglfw3 libgl1 libfdk-aac-dev libass-dev \
    ...
    libyaml-cpp-dev libboost-python-dev libboost-numpy-dev \
    libgles2-mesa-dev patchelf libgl1-mesa-dev libglew-dev \
    libosmesa6-dev libgl1-mesa-dri
```
